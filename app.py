...
async def login_user(
    ...
    #invalid user, throw an exception
    if not db_user:
...
async def create_post(
    ...
    return await _services.create_post(user = user, post = post_request, db = db)
...
async def update_post(
   ...
   updated_post = await _services.update_post(post = db_post, post_request= post_request, db = db)
   return updated_post